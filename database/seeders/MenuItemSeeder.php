    ...
    public function run(): void
    {
        $menuItems = [
            ...
            [
                ...
                'image' => 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=300&fit=crop',
                'preparation_time' => '4-5 min',
                'ingredients' => ['Espresso', 'Chocolate syrup', 'Steamed milk', 'Whipped cream', 'Cocoa powder'],
                'allergens' => ['Dairy'],
                'calories' => 320,
                'status' => 'active',
            ],
            ...
            [
                ...
                'image' => 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=400&h=300&fit=crop',
                'preparation_time' => '3-4 min',
                'ingredients' => ['Espresso', 'Cold milk', 'Caramel syrup', 'Ice', 'Caramel sauce'],
                'allergens' => ['Dairy'],
                'calories' => 280,
                'status' => 'active',
            ],
            [
                ...
                'preparation_time' => '5-6 min',
                'ingredients' => ['Avocado', 'Artisan bread', 'Cherry tomatoes', 'Sea salt', 'Olive oil'],
                'allergens' => ['Gluten'],
                'calories' => 420,
                'status' => 'active',
            ],
            [
                ...
                'image' => 'https://images.unsplash.com/photo-1597318374671-96ee162414ca?w=400&h=300&fit=crop',
                'preparation_time' => '4-5 min',
                'ingredients' => ['Chai tea blend', 'Steamed milk', 'Honey', 'Cinnamon'],
                'allergens' => ['Dairy'],
                'calories' => 200,
                'status' => 'active',
            ],
            ...
            [
                ...
                'preparation_time' => '8-10 min',
                'ingredients' => ['Flour', 'Fresh blueberries', 'Eggs', 'Milk', 'Maple syrup', 'Butter'],
                'allergens' => ['Gluten', 'Dairy', 'Eggs'],
                'calories' => 520,
                'status' => 'active',
            ],
            [
                ...
                'preparation_time' => '3-4 min',
                'ingredients' => ['Matcha powder', 'Cold milk', 'Ice', 'Simple syrup'],
                'allergens' => ['Dairy'],
                'calories' => 160,
                'status' => 'active',
            ],
